 ...
 * Author: Isaac Cruz
 * Course: COMP-003A
 * Purpose: discussing different types of conditional statements and operators in C#
 */

namespace COMP003A_Activity_4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                // this code block executes if the above condition is true
                // the rest of th econditions will no longer execute
            ...
            Console.WriteLine($"\t{inputNumber} == {randomNumber} && {inputNumber} >= {randomNumber}: " + $"\t{inputNumber} == {randomNumber} || {inputNumber == randomNumber && inputNumber >= randomNumber}");
